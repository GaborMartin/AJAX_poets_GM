...
let worksContentDivEl;
let workContentDivEl;
...
function setAuthorization(user) {
    return localStorage.setItem('poet', JSON.stringify(user));
}
...
function onLoad() {
    ...
    worksContentDivEl = document.getElementById('works-content');
    workContentDivEl = document.getElementById('work-content');
